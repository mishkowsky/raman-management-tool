...
from PySide6.QtWidgets import QMainWindow, QFileDialog, QColorDialog, QMessageBox, QApplication, QFrame
...
class MainWindow(QMainWindow):
    ...
    def changeSelectedLineColor(self):
        dialog = QColorDialog()
        dialog.setWindowIcon(QtGui.QIcon(':/icons/images/icons/cil-paint-bucket.png'))
    ...
    def showChooseFilesMessage(self):
        ...
        msgBox.setWindowTitle('Not enough measurements to count')
        msgBox.setStandardButtons(QMessageBox.StandardButton.Ok)
        msgBox.setStyleSheet(MAIN_STYLE)
