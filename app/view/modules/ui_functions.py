from PySide6.QtCore import QPropertyAnimation, QEasingCurve, QParallelAnimationGroup, QEvent, Qt, QTimer
...
from app.view.modules.custom_grips import CustomGrip
